...
import re
import sys
import assembler.lang as lang
from assembler.expression import ConstantExpression
from assembler.state import State, AssemblerError
...
def save_binary(code, filename):
    pass

def save_eeprom(code, filename):
    pass
...
if __name__ == "__main__":
    ...
    data = assemble(f, args.format, args.hub_offset, syntax_version = args.syntax)
